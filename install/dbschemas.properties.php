...
$Tables["articles_comments"]["schema"] = "
  ...
  user_email C(200) DEFAULT '',
  user_url C(200) DEFAULT '',
  user_name C(200) NOTNULL DEFAULT Anonymous,
...
$Tables["blogs"]["schema"] = "
  ...
  create_date T NOTNULL,
  last_update_date T NOTNULL,
...
$Tables["mylinks"]["schema"] = "
  ...
  blog_id I(10) UNSIGNED NOTNULL DEFAULT '0',
  rss_feed C(200) NOTNULL DEFAULT '',
  date T NOTNULL,
  properties TEXT NOTNULL DEFAULT '',
  INDEX blog_id (blog_id),
...
$Tables["users"]["schema"] = "
  ...
  email C(200) NOTNULL DEFAULT '',
  full_name C(200) NOTNULL DEFAULT '',
  about X,
  properties TEXT NOTNULL DEFAULT '',
  status I(4) NOTNULL DEFAULT 1,
...
$Tables["config"]["schema"] = "
   config_key C(200) NOTNULL DEFAULT '' PRIMARY,
...
$Tables["gallery_resources"]["schema"] = "
   ...
   file_path C(200) DEFAULT '',
   file_name C(200) DEFAULT '',
...
$Tables["gallery_albums"]["schema"] = "
   ...
   normalized_description TEXT NOTNULL DEFAULT '',
   normalized_name C(200) NOTNULL DEFAULT '',
   mangled_name C(200) NOTNULL DEFAULT '',
...
$Tables["custom_fields_definition"]["schema"] = "
   id I(10) NOTNULL AUTOINCREMENT PRIMARY,
   field_name C(200) NOTNULL DEFAULT '' PRIMARY,
