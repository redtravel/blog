...
1. Introduction
===========================
Now, almost every template used in LifeType is based on <Div> tag to design the 
...
LifeType system, just simple do as following steps.
...
A. Solution 1: Add my template by menaul:
	...
	b. Enter your LifeType administration interface, choose Site Admin -> Add 
...
B. Solution 2: Add my template by upload one compressed file
	...
	a. Enter your LifeType administration interface, choose Site Admin -> Add 
