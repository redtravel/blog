<?php /* Smarty version 2.6.26, created on 2016-11-02 13:07:27
         compiled from andreas-3-columns/error.template */ ?>
...
<div id="content">
 <h2><?php echo $this->_tpl_vars['locale']->tr('error'); ?>
</h2>
 <p><?php echo $this->_tpl_vars['locale']->tr($this->_tpl_vars['message']); ?>
</p>
 <p><a href="javascript:history.go(-1)"><?php echo $this->_tpl_vars['locale']->tr('back'); ?>
</a></p>
 </div>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
