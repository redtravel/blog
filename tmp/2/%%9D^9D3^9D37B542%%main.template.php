<?php /* Smarty version 2.6.26, created on 2016-11-01 23:49:57
         compiled from admin/main.template */ ?>
...
unset($_smarty_tpl_vars);
 ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => ($this->_tpl_vars['admintemplatepath'])."/navigation.template", 'smarty_include_vars' => array('showOpt' => 'Manage','title' => $this->_tpl_vars['locale']->tr('Manage'))));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
<?php echo $this->_tpl_vars['menu']->generateAt('Manage',2); ?>
